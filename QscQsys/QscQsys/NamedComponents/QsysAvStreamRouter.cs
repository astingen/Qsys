...
namespace QscQsys.NamedComponents
{
    ...
    /// </summary>
    [PublicAPI("S+")]
    public sealed class QsysAvStreamRouter : AbstractQsysComponent
    {
        ...
        protected override void HandleComponentUpdated(NamedComponent component)
        {
            ...
            InputControl = component.LazyLoadComponentControl(ControlNameUtils.GetAvStreamRouterSelectName(Output));
        }
